      ...
      <main className="content">
        ...
        <div className="bags-list">
          ...
          <ul>
            ...
            <li><strong>Minerals & Powders:</strong> Smooth discharge of minerals, pigments, or powdered metals</li>
            <li><strong>Tobacco & Reprocessing:</strong> Efficient storage and movement of leaf or shredded material</li>
            <li><strong>Construction:</strong> Handling sticky cement, sand, or slurry-based products</li>
        ...
        <div className="bags-list">
          ...
          <ul>
            ...
            <li>Mining and Mineral Handling</li>
            <li>Petrochemical and Polymer Industries</li>
